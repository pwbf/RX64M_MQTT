...
/***********************************************************************************************************************
* Function Name: r_r_irq_rx_irq7_interrupt
...
#pragma interrupt r_r_irq_rx_irq7_interrupt(vect=VECT(ICU,IRQ7),fint)
#else
#pragma interrupt r_r_irq_rx_irq7_interrupt(vect=VECT(ICU,IRQ7))
#endif
static void r_r_irq_rx_irq7_interrupt(void)
{
    /* Start user code for r_r_irq_rx_irq1_interrupt. Do not edit comment generated here */
    TCP_Terminate(1);
    //LED1 = 1;
    /* End user code. Do not edit comment generated here */
}
